...
import { DecodedJWT, ErrorResponse, TokenResponse ,LoginRequest} from "./types/token";
    ...
    Credentials({
      ...
      async authorize(credentials) {
        try {
          ...
          const res = await AxiosAPI.post<TokenResponse>("api/Identity/login", loginData as any );

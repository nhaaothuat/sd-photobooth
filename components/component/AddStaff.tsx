    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit} className="grid gap-4 py-2">
          ...
          <div className="grid gap-2">
            <Label>Gender</Label>
            <Select onValueChange={handleGenderChange} defaultValue={formData.gender.toString()}>
              <SelectTrigger>
          ...
          <div className="grid gap-2">
            ...
            <Select onValueChange={handleLocationChange} value={formData.locationId.toString()}>
              <SelectTrigger>

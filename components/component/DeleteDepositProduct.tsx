...
const DeleteDepositProduct = ({ id, onDeleteSuccess }: DeleteDepositProductProps) => {
     ...
     return (
          <>
               ...
               >
                    ...
                    <Text mb="md">Bạn có chắc chắn muốn xóa sản phẩm này? Hành động này không thể hoàn tác.</Text>

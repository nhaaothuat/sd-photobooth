...
import { Badge, Card, Group, Indicator, SimpleGrid, Text } from '@mantine/core'
...
const ByTypeSessionProduct = () => {
     ...
     useEffect(() => {
          const fetchStickersByStyle = async () => {
               ...
               try {
                    const response = await AxiosAPI.get<TypeSessionProduct[]>(`/api/TypeSessionProduct/GetByTypeSessionId/${selectedStyleId}`)
